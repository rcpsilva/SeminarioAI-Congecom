...
\begin{frame}{Reflexão}
  \begin{itemize}
    \item Pense em uma resposta recente da IA que você aceitou rápido demais. O que um discernimento mais apurado teria notado?
  ...
  \end{itemize}
  \vspace{0.3cm}
  \begin{alertbox}{Para praticar}
    \small Na próxima resposta que a IA te der, escolha um dos três tipos e aplique de propósito, antes de aceitar o resultado.
  \end{alertbox}
\end{frame}
...
\begin{frame}{Passo 1: entenda a declaração (3 min)}
  \begin{notebox}{O que é}
...
\begin{frame}{Passo 3: redija sua declaração (6 min)}
  \begin{notebox}{Como fazer}
